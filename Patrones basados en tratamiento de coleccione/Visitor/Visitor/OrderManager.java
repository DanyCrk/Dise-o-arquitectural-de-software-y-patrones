...
public class OrderManager extends JFrame {
  ...
  public static final String BRAZILIAN_ORDER = 
    "Brazilian Order";
  ...
  public OrderManager() {
    ...
    lblAdditionalSH =
      new JLabel("Additional S & H(Overseas Orders or Brazilian Order):");
    ...
    System.out.println("Error al aplicar LookAndFeel: " + ex);
}
