...
public class SearchManager extends JFrame {
  ...
  public static final String ASSISTANT_OR_INTERN = "Assistant or intern SQL Statement";
  ...
  public SearchManager() throws Exception {
    ...
    cmbSearchType.addItem(SearchManager.ASSISTANT_OR_INTERN);
    // Create Labels
...
class BuilderFactory {
  public UIBuilder getUIBuilder(String str) {
    ...
    if (str.equals(SearchManager.ASSISTANT_OR_INTERN)) {
      builder = new AssorIntBuilder();
